...
//            await _teamRepository.AddMemberAsync(teamId, new UserId(member.ChannelId, member.Id));
...
//            var team = new Team(teamId, teamName, pin, new UserId(leader.ChannelId, leader.Id));
